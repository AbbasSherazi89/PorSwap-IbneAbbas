        ...
        <div className="container">
          <div className="row">
            ...
            <div className="col-md-6 d-flex ">
              <Link className="nav-link ms-auto" aria-current="page" to="/home">
            ...
            <div className="row mt-3">
                <div className="col-md-6"><p className="Footer-p">Decentralized Spot and Futures <br/> Trading on Binance Smart Chain  </p></div>
                <div className="col-md-6">
                    <Link className="Footer-link" href="">exchange@porkswap.finance</Link>
                </div>
            </div>
